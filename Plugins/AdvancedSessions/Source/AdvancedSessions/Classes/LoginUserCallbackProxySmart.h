...
#include "LoginUserCallbackProxySmart.generated.h"

UCLASS(MinimalAPI)
class ULoginUserCallbackProxySmart : public UOnlineBlueprintCallProxyBase
{
	...
	static ULoginUserCallbackProxySmart* LoginUserSmart(UObject* WorldContextObject, class APlayerController* PlayerController, FString UserID, FString UserToken, FString AuthType);
